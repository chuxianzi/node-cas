...
console.log('star join cas kaishijinru');
...
{
    console.log('elemSuccess=========================star');
    console.log(elemSuccess);
    console.log('elemSuccess=========================end');
    var attributes = {};
    var elemAttribute = elemSuccess.find('cas\\:attributes').first();
    console.log('elemAttribute=========================star');
    console.log(elemAttribute);
    console.log('elemAttribute=========================end');
